...
<div class="wrapper">
                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li class="active active-menu">
                        ...
                        <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                            <li class="active"><a href="index-2.html"><i class="las la-house-damage"></i>Home</a></li>
    ...
    <div id="content-page" class="content-page">
        <div class="container-fluid">
                                    ...
                                    <div class="d-flex align-items-top justify-content-between iq-music-play-detail">
                                        <div class="music-detail">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <p onclick="playpauseTrack()" class="btn btn-primary iq-play mr-2">Play Music</p>
                                            </div>
                                        </div>
                                        <div class="music-right">
                                            <div class="d-flex align-items-center">
                                                <div class="iq-circle mr-2 share"><a href="javascript:void(0);"><i class="las la-share-alt-square text-primary"></i></a></div>
                                                <div class="iq-circle mr-2"><a href="javascript:void(0);"><i class="ri-heart-fill  text-primary"></i></a></div>
                                                <div class="iq-circle">
                                                    <a href="javascript:void(0);"><i class="las la-download text-primary"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-12">
                <div class="iq-card" style="background-color: white;">
                                ...
                                <div class="d-flex justify-content-between align-items-center row">
                                    <div class="media align-items-center col-10 col-md-5">
                                        <div class="iq-realese-song ">
                                            <a href="javascript:void(0);"><img src="img/index-page/dashboard/realease-song/01.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                        </div>
                                        <div class="media-body ml-3">
                                            <p class="mb-0">Wolf Children</p>
                                            <small>First Echo</small>
                                        </div>
                                    </div>
                                    ...
                                    <p class="mb-0 col-2 col-md-2 iq-music-play" onclick="playpauseTrack()"><i class="las la-play-circle font-size-32"></i></p>
                            ...
                            <li class="mb-3">
                                <div class="d-flex justify-content-between align-items-center row">
                                    <div class="media align-items-center col-10 col-md-5">
                                        ...
                                        <div class="media-body ml-3">
                                            <p class="mb-0">Attack On Titan</p>
                                            <small>Dead On Arrival</small>
                                        </div>
                                    </div>
                                    <p class="mb-0 col-md-2 col-md-2 iq-music-time">9:52</p>
                                    <p class="mb-0 col-md-2 col-md-2 iq-musc-icone"><i class="lar la-star font-size-20"></i></p>
                            ...
                            <li class="mb-3">
                                <div class="d-flex justify-content-between align-items-center row">
                                    <div class="media align-items-center col-10 col-md-5">
                                        ...
                                        <div class="media-body ml-3">
                                            <p class="mb-0">Mob Psycho 100 Season 1</p>
                                            <small>The Smell of Spirits</small>
                                        </div>
                                    </div>
                                    <p class="mb-0 col-md-2 col-md-2 iq-music-time">9:52</p>
                                    <p class="mb-0 col-md-2 col-md-2 iq-musc-icone"><i class="lar la-star font-size-20"></i></p>
                            ...
                            <li class="mb-3">
                                <div class="d-flex justify-content-between align-items-center row">
                                    <div class="media align-items-center col-10 col-md-5">
                                        ...
                                        <div class="media-body ml-3">
                                            <p class="mb-0">Fullmetal Alchemist</p>
                                            <small>Again</small>
                                        </div>
                                    </div>
                                    <p class="mb-0 col-md-2 col-md-2 iq-music-time">9:52</p>
                            ...
                            <li class="mb-3">
                                <div class="d-flex justify-content-between align-items-center row">
                                    <div class="media align-items-center col-10 col-md-5">
                                        ...
                                        <div class="media-body ml-3">
                                            <p class="mb-0">Clannad After Story</p>
                                            <small>Dango Daikazoku</small>
                                        </div>
                                    </div>
                                    <p class="mb-0 col-md-2 col-md-2 iq-music-time">9:52</p>
                                    <p class="mb-0 col-md-2 col-md-2 iq-musc-icone"><i class="lar la-star font-size-20"></i></p>
