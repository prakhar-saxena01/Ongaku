...
<div class="wrapper">
    ...
    <div class="iq-sidebar">
        <div class="iq-sidebar-logo d-flex justify-content-between">
            <a href="#" class="header-logo">
                <img src="img/index-page/logo.png" class="img-fluid rounded-normal" alt="">
    ...
    <!-- TOP Nav Bar -->
    <div class="iq-top-navbar" style="background-color:#27292c;">
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                    ...
                    <div class="iq-navbar-logo d-flex justify-content-between">
                        <a href="#" class="header-logo">
                            ...
                            <div class="pt-2 pl-2 logo-title">
                                <span class="text-primary text-uppercase">Ongaku</span>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="iq-menu-top d-flex justify-content-between mb-0 p-0" style="list-style:none; margin-left:70px;">
                        <li class="active" style="margin-right: 30px;"><a href="#">Home</a></li>
                        <li><a href="latest.html" style="margin-right: 30px; color:white;">Latest</a></li>
                        <li><a href="albums.html" style="color:white;">Albums</a></li>
                    </ul>
                    <ul class="navbar-nav ml-auto navbar-list">
                        <li class="nav-item nav-icon">
                            <div class="iq-search-bar">
                                <form action="#" class="searchbox">
                                    ...
                                    <a class="search-audio" href="#"><i class="las la-microphone text-white"></i></a>
                                </form>
                            </div>
                        </li>
                        ...
                        <li class="nav-item nav-icon">
                            <a href="#" class="search-toggle iq-waves-effect text-white rounded">
                                    ...
                                    <div class="iq-card-body p-0 ">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="img/index-page/user/01.jpg" alt="">
                                                </div>
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="img/index-page/user/02.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="img/index-page/user/03.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="img/index-page/user/04.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="img/index-page/user/05.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                ...
                                <div class="iq-card shadow-none m-0">
                                    <div class="iq-card-body p-0">
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded img-fluid" src="img/index-page/user/01.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded img-fluid" src="img/index-page/user/02.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded img-fluid" src="img/index-page/user/03.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                        ...
                                        <a href="#" class="iq-sub-card" >
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded img-fluid" src="img/index-page/user/04.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                        ...
                        <li class="line-height pt-3">
                            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                <img src="img/index-page/user/11.png" class="img-fluid rounded-circle" alt="user">
                            </a>
    ...
    <!-- TOP Nav Bar END -->
    <!-- Page Content  -->
    <div id="content-page" class="content-page" style="background-color:#151718;">
            ...
            <div class="row">
                                    ...
                                    <ul class="list-unstyled iq-song-slide mb-0 realeases-banner">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/01.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">Dragon Ball Z</p>
                                                        <small>Destruction</small>
                                                    </div>
                                                </div>
                                                <p class="mb-0 col-md-2  iq-m-time">2:37</p>
                                                <p class="mb-0 col-md-2 iq-m-icon"><i class="lar la-star font-size-20"></i></p>
                                                <p class="mb-0 col-2 col-md-2 playpause-track" onclick="playpauseTrack()"><i class="las la-play-circle font-size-32"></i></p>
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/02.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">Sword Art Online</p>
                                                        <small>Heart Sweet Heart</small>
                                                    </div>
                                                </div>
                                                <p class="mb-0 col-md-2 iq-m-time">4:16</p>
                                                <p class="mb-0 col-md-2 iq-m-icon"><i class="lar la-star font-size-20"></i></p>
                                                <p class="mb-0 col-2 col-md-2 playpause-track"><i class="las la-play-circle font-size-32" onclick="playpauseTrack()"></i></p>
                                                <div class="iq-card-header-toolbar iq-music-drop  d-flex align-items-center col-md-1">
                                                    <div class="dropdown">
                                        ...
                                        <li class="active row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/03.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">1000 Words</p>
                                                        <small>Koda Kumi</small>
                                                    </div>
                                                </div>
                                                <p class="mb-0 col-md-2 iq-m-time">3:16</p>
                                                <p class="mb-0 col-md-2 iq-m-icon"><i class="lar la-star font-size-20"></i></p>
                                                <p class="mb-0 col-2 col-md-2 playpause-track"><i class="las la-play-circle font-size-32" onclick="playpauseTrack()"></i></p>
                                                <div class="iq-card-header-toolbar iq-music-drop d-flex align-items-center col-md-1">
                                                    <div class="dropdown">
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/04.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">One Piece</p>
                                                        <small>Believe</small>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/05.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">Demon Slayer</p>
                                                        <small>Gurenge</small>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/06.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/07.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                                        <p class="mb-0 iq-music-title">Jawsh 685 x Jason Derulo </p>
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/08.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                        ...
                                        <li class="row">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="media align-items-center col-10 col-md-5">
                                                    <div class="iq-realese-song ">
                                                        <a href="music-player"><img src="img/index-page/dashboard/realease-song/09.png" class="img-border-radius avatar-60 img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="media-body text-white ml-3">
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                ...
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/01.gif" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/02.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                            ...
                                            <div class="feature-list text-center">
                                                <h6 class="font-weight-600 mb-0">Kenshei Yonzeu</h6>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/03.gif" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/04.gif" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/05.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/06.gif" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/07.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/08.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/feature-album/09.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                            ...
                            <ul class="list-unstyled row feature-album-artist mb-0">
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/01.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/02.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/03.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/04.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/05.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/06.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/07.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/08.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/09.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                            <a href="music-player">
                                                <i class="las la-play-circle"></i>
                                ...
                                <li class="col-lg-2  iq-music-box">
                                    <div class="iq-thumb-artist">
                                        <div class="iq-music-overlay"></div>
                                        <a href="music-player">
                                            <img src="img/index-page/dashboard/feature-album-artist/10.png" class="w-100 img-fluid" alt="">
                                        </a>
                                        <div class="overlay-music-icon">
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/01.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/02.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/03.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/04.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/05.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/06.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/07.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/08.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/09.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/10.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-sm-0 mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/11.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0 mb-sm-0 mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/tranding-song/12.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                ...
                <div class="col-lg-12">
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Popular Anime Series Songs</h4>
                            </div>
                            <div class="d-flex align-items-center">
                                <b class="mb-0 text-primary"><a href="albums.html">View More <i class="las la-angle-right"></i></a></b>
                            </div>
                                    ...
                                    <div class="iq-card ">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="/music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/01.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/02.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/03.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/04.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/05.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player.html">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/06.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player.html">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/07.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/08.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-sm-0  mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/09.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/10.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player.html">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-sm-0 mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/11.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                    ...
                                    <div class="iq-card mb-0 mb-sm-0 mb-md-0 mb-lg-0">
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <div class="iq-music-overlay"></div>
                                                <a href="music-player">
                                                    <img src="img/index-page/dashboard/popular-hindi-song/12.png" class="img-border-radius img-fluid w-100" alt="">
                                                </a>
                                                <div class="overlay-music-icon">
                                                    <a href="music-player">
                                                        <i class="las la-play-circle"></i>
                                                ...
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/01.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                            ...
                                            <div class="iq-card iq-card-transparent">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/02.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent mb-0 mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/03.png"  class="img-fluid avatar-60" alt=""></a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                                                </a>
                                            ...
                                            <div class="iq-card iq-card-transparent">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/04.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player.html"><img src="img/index-page/dashboard/hot-songs/05.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player.html">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent mb-0 mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/06.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/07.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/08.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                            ...
                                            <div class="iq-card iq-card-transparent mb-0 mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="media align-items-center">
                                                        <div class="iq-thumb-hotsong">
                                                            <div class="iq-music-overlay"></div>
                                                            <a href="music-player"><img src="img/index-page/dashboard/hot-songs/09.png"  class="img-fluid avatar-60" alt="">
                                                            </a>
                                                            <div class="overlay-music-icon">
                                                                <a href="music-player">
                                                                    <i class="las la-play-circle font-size-24"></i>
                                        ...
                                        <li class="col-lg-6">
                                            <div class="iq-card  mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="iq-thumb">
                                                        <video  controls>
                                                            <source src="img/index-page/dashboard/song-video/video-1.mp4" type="video/mp4" />
                                                        </video>
                                                    </div>
                                                    <div class="feature-list text-center">
                                        ...
                                        <li class="col-lg-6">
                                            <div class="iq-card mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="iq-thumb">
                                                        <video controls>
                                                            <source src="img/index-page/dashboard/song-video/video-2.mp4" type="video/mp4" />
                                                        </video>
                                                    </div>
                                                    <div class="feature-list text-center">
                                        ...
                                        <li class="col-lg-6">
                                            <div class="iq-card  mb-lg-0">
                                                <div class="iq-card-body p-0">
                                                    <div class="iq-thumb">
                                                        <video controls>
                                                            <source src="img/index-page/dashboard/song-video/video-3.mp4" type="video/mp4" />
                                                        </video>
                                                    </div>
                                                    <div class="feature-list text-center">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="player row">
                    <div class="details col-6 col-sm-6 col-lg-4">
...
<!-- Mirrored from iqonic.design/themes/muzik/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Aug 2020 17:00:35 GMT -->
</html>
